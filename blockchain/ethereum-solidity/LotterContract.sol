...
contract Lottery {
    ...
    function random_pseudo() private view returns (uint) {
        return uint(keccak256(block.difficulty, now, players));  // sha3 is a global function same with keccak256
    }
    ...
    function pickWinner() public restricted {
        ...
        uint index = random_pseudo() % players.length;
